    ...
    content: |
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "A code generator parses the official Telegram Bot API documentation, extracts type definitions and method signatures from the HTML, and outputs TypeScript. The current version covers 359 types and 180 methods."
            }
          },
          {
            "@type": "Question",
